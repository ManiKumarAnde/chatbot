...
intents = [
    
    {
        ...
        "responses": [
            "Hey Hello Mani, How can i asssit you "
        ]
    },
    {
        "tag": "goodbye",
    ...
    },
    {
        ...
        "responses": [
            "Mani Kumar Ande, a B.Tech graduate in CSE (2024, CGPA 7.5) from JNTUA College of Engineering, is skilled in Android development, Java, and Jetpack Compose, with experience in embedded systems and IoT. Currently focused on Android development and aspiring to work for ISRO/BARC and explore astronomy. "        ]
    },
...
def main():
    ...
    if choice == "Home":
        ...
        if not os.path.exists('chat log.csv'):
            with open('chat log.csv', 'w', newline='', encoding='utf-8') as csvfile:
        ...
        with open('chat_log.csv', 'r', encoding='utf-8') as csvfile:
            ...
            for row in csv_reader:
                st.text(f"User: {row[0]}")  # Corrected formatting
                st.text(f"Chatbot: {row[1]}")
                st.text(f"Timestamp: {row[2]}")
                st.markdown("---")  # Use three dashes for a horizontal line
 
    elif choice == "About":
        st.write("The goal of this project is to create a chatbot that can unders")
        st.subheader("Project Overview:")
        st.write("""
The project is divided into two parts:
1. NLP techniques and Logistic Regression algorithm is used to train the
2. For building the Chatbot interface, Streamlit web framework is used to""")
